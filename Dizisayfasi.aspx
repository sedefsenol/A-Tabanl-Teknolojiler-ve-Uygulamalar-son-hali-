...
<script>
    ...
    fetch(`https://api.themoviedb.org/3/tv/${diziId}?api_key=${API_KEY}&language=tr-TR`)
        ...
        .then(data => {
            ...
            // Başlık
            document.getElementById("movieTitle").innerText = data.name;
            ...
            document.getElementById("<%= hfFilmAdi.ClientID %>").value = data.name;
    ...
    // Sayfa açıldığında kayıtlı puanı göster
    (function initStars() {
